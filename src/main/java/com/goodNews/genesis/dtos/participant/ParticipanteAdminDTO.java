...
public record ParticipanteAdminDTO(
        ...
        public ParticipanteAdminDTO(ParticipantsEntity entity) {
                this(
                                ...
                                entity.getTravelInformation() != null
                                                && entity.getTravelInformation().getTipoTransporte() != null
                                                                ? entity.getTravelInformation().getTipoTransporte()
                                                                                .name()
                                                                : null,
                                entity.getTravelInformation() != null
                                                ? entity.getTravelInformation().getEmpresaTransporte()
                                                : null,
                                entity.getTravelInformation() != null ? entity.getTravelInformation().getNroVuelo()
                                                : null,
                                entity.getTravelInformation() != null ? entity.getTravelInformation().getLugarLlegada()
                                                : null);
        }
}