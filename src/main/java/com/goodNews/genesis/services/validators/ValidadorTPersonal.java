...
@Component
public class ValidadorTPersonal implements ValidadorTransporteStrategy {

	@Override
	public void validar(ViajeData data) {
		if (data.fechaLlegada() == null || data.fechaIda() == null)
			throw new BadRequestException("Todos los datos del viaje son necesarios");
	}

	@Override
	public boolean aplicarPara(MedTransporteEnum tiporansporte) {
		return MedTransporteEnum.INDEPENDIENTE == tiporansporte;
